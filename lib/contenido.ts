...
export const CONTENIDO_DEFAULTS: ContenidoSitio = {
  ...
  footer_copyright: "© 2025 Delfos Constructora. Todos los derechos reservados.",
  ...
  terminos: [
    ...
    },
    {
      ...
      contenido:
        "Todos los diseños ofrecidos en este sitio son propiedad de Delfos Constructora y están protegidos por las leyes de propiedad intelectual.",
    },
    {
    ...
    },
    {
      ...
      contenido:
        "Delfos Constructora se reserva el derecho de modificar los presentes términos y condiciones en cualquier momento.",
    },
    {
